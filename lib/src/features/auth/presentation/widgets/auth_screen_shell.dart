      ...
      body: WatercolorScaffold(
        child: SafeArea(
          ...
          child: SingleChildScrollView(
            padding: EdgeInsets.fromLTRB(24, topPadding > 0 ? 4 : 20, 24, 28),
            child: ConstrainedBox(
              constraints: BoxConstraints(
                minHeight: MediaQuery.sizeOf(context).height - topPadding - 28,
              ),
              child: Column(
                ...
                children: [
                  ...
                  const Align(
                    ...
                    child: Opacity(opacity: 0.82, child: LeafAccent(size: 46)),
                  ),
