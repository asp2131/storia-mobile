...
class _AddChildScreenState extends ConsumerState<AddChildScreen> {
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Create a reading profile so Storia can personalize progress, continue-reading, and session tracking for one child at a time.',
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Only display name and age band are required. Reading level is optional for now.',
                                ...
                                Semantics(
                                  ...
                                  child: DecoratedBox(
                                    ...
                                    child: SwitchListTile.adaptive(
                                      ...
                                      subtitle: Text(
                                        'Storia will open the library with this child selected first.',
                                        style: textTheme.bodyMedium?.copyWith(
                                          color: StoriaColors.inkMuted,
                                          height: 1.35,
                                        ),
  ...
  String _errorMessage(Object error) {
    if (error is ApiClientException) {
      ...
      final detail = body != null && body.isNotEmpty
          ? ' — ${body.length > 200 ? '${body.substring(0, 200)}…' : body}'
          : '';
      return 'Save failed (HTTP ${status ?? '?'})$detail';
    }
    return 'Could not save this child profile: $error';
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      debugPrint('[AddChildScreen] createChild failed: $error');
